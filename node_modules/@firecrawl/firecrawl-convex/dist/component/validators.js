 ...
 */
export const formatValidator = v.union(v.literal("markdown"), v.literal("html"), v.literal("rawHtml"), v.literal("links"), v.literal("images"), v.literal("screenshot"), v.literal("summary"), v.literal("changeTracking"), v.literal("json"), v.literal("attributes"), v.literal("branding"), v.literal("product"), v.literal("menu"), v.literal("audio"), v.literal("video"), v.object({
    type: v.string(),
    // json / changeTracking
    ...
    // attributes
    selectors: v.optional(v.array(v.object({ selector: v.string(), attribute: v.string() }))),
    // question / highlights
...
export const mapOptionsValidator = v.object({
    ...
    sitemap: v.optional(v.union(v.literal("only"), v.literal("include"), v.literal("skip"))),
