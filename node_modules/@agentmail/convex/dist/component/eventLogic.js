 ...
 */
export function sendPath(inboxId, kind, parentMessageId) {
    ...
    switch (kind) {
        ...
        case "reply":
            if (!parentMessageId)
                throw new Error("parentMessageId required for reply");
 ...
 */
export function extractIndexFields(event) {
 ...
 */
export function mapEventToOutboundStatus(eventType) {
    switch (eventType) {
        case "message.sent":
            return "sent";
...
//# sourceMappingURL=eventLogic.js.map