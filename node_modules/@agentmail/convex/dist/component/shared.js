...
export const vOutboundStatus = v.union(v.literal("pending"), v.literal("sent"), v.literal("failed"), v.literal("delivered"), v.literal("bounced"), v.literal("complained"), v.literal("rejected"));
export const vSendKind = v.union(v.literal("send"), v.literal("reply"), v.literal("reply_all"), v.literal("forward"));
...
export const vEventType = v.union(v.literal("message.received"), v.literal("message.sent"), v.literal("message.delivered"), v.literal("message.bounced"), v.literal("message.complained"), v.literal("message.rejected"), v.literal("domain.verified"));
