 ...
 */
export declare function withoutSystemFields<T extends Record<string, any>>(obj: T): Expand<BetterOmit<T, "_creationTime" | "_id">>;
 ...
 */
export declare function assert(value: unknown, message?: string | (() => string)): asserts value;
export {};
