import type { DataModelFromSchemaDefinition, Expand, GenericDatabaseReader, SchemaDefinition, TableNamesInDataModel } from "convex/server";
import type { GenericId, GenericValidator, Infer, ObjectType, OptionalProperty, PropertyValidators, Validator, VAny, VArray, VBoolean, VBytes, VCommitTs, VFloat64, VId, VInt64, VLiteral, VNull, VObject, VOptional, VRecord, VString, VUnion } from "convex/values";
 ...
 */
export declare const nullable: <V extends Validator<any, "required", any>>(x: V) => VUnion<(V | VNull<null, "required">)["type"], [VNull<null, "required">, V], "required", (V | VNull<null, "required">)["fieldPaths"]>;
/**
