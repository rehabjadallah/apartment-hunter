...
import { zid as zid3, type ZCustomCtx as ZCustomCtx3, zCustomQuery as zCustomQuery3, zCustomMutation as zCustomMutation3, zCustomAction as zCustomAction3, type CustomBuilder as CustomBuilder3, type ConvexValidatorFromZodOutput as ConvexValidatorFromZodOutput3, Zid as Zid3, ZodBrandedInputAndOutput as ZodBrandedInputAndOutput3, zBrand as zBrand3, type ConvexToZod as ConvexToZod3, type ZodValidatorFromConvex as ZodValidatorFromConvex3, convexToZod as convexToZod3, convexToZodFields as convexToZodFields3, type ConvexValidatorFromZod as ConvexValidatorFromZod3 } from "./zod3.js";
import type { GenericValidator, PropertyValidators } from "convex/values";
import type { FunctionVisibility } from "convex/server";
import { type ConvexValidatorFromZod as ConvexValidatorFromZod4, type ConvexValidatorFromZodOutput as ConvexValidatorFromZodOutput4, type Zid as Zid4 } from "./zod4.js";
/**
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
export declare const zid: typeof zid3;
/**
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
 ...
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
export declare const zCustomQuery: typeof zCustomQuery3;
/**
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
export declare const zCustomMutation: typeof zCustomMutation3;
/**
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
export declare const zCustomAction: typeof zCustomAction3;
/**
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
export type CustomBuilder<FuncType extends "query" | "mutation" | "action", CustomArgsValidator extends PropertyValidators, CustomCtx extends Record<string, any>, CustomMadeArgs extends Record<string, any>, InputCtx, Visibility extends FunctionVisibility, ExtraArgs extends Record<string, any>> = CustomBuilder3<FuncType, CustomArgsValidator, CustomCtx, CustomMadeArgs, InputCtx, Visibility, ExtraArgs>;
/**
 ...
 */
export declare function zodToConvex<Z extends z4Core.$ZodType>(validator: Z): ConvexValidatorFromZod4<Z, "required">;
export declare function zodToConvex<Z extends z3.ZodTypeAny>(validator: Z): ConvexValidatorFromZod3<Z>;
/**
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
export type ConvexValidatorFromZodOutput<Z extends z3.ZodTypeAny> = ConvexValidatorFromZodOutput3<Z>;
/**
 ...
 * @throws If there is no equivalent Convex validator for the value (e.g. `z.date()`)
 */
export declare function zodOutputToConvex<Z extends z4Core.$ZodType>(validator: Z): ConvexValidatorFromZodOutput4<Z, "required">;
export declare function zodOutputToConvex<Z extends z3.ZodTypeAny>(validator: Z): ConvexValidatorFromZodOutput3<Z>;
/**
 ...
 */
export declare function zodToConvexFields<Fields extends Record<string, z4Core.$ZodType>>(fields: Fields): {
    [k in keyof Fields]: ConvexValidatorFromZod4<Fields[k], "required">;
};
export declare function zodToConvexFields<Fields extends Record<string, z3.ZodTypeAny>>(fields: Fields): {
 ...
 * @returns Object with the same keys, but with Convex validators as values
 */
export declare function zodOutputToConvexFields<Fields extends Record<string, z4Core.$ZodType>>(fields: Fields): {
    [k in keyof Fields]: ConvexValidatorFromZodOutput4<Fields[k], "required">;
};
export declare function zodOutputToConvexFields<Fields extends Record<string, z3.ZodTypeAny>>(fields: Fields): {
 ...
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
export declare const ZodBrandedInputAndOutput: typeof ZodBrandedInputAndOutput3;
/**
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
export declare const zBrand: typeof zBrand3;
/**
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
 ...
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
export type ZodValidatorFromConvex<V extends GenericValidator> = ZodValidatorFromConvex3<V>;
/**
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
export declare const convexToZod: typeof convexToZod3;
/**
 * @deprecated Please import from `convex-helpers/server/zod3` instead.
 */
export declare const convexToZodFields: typeof convexToZodFields3;
