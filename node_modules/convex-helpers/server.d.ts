...
export declare function Table<T extends Record<string, Validator<any, any, any>>, TableName extends string>(name: TableName, fields: T): {
    name: TableName;
    table: import("convex/server").TableDefinition<import("convex/values").VObject<import("convex/server").Expand<{ [Property in { [Property in keyof T]: T[Property]["isOptional"] extends "optional" ? Property : never; }[keyof T]]?: Exclude<Infer<T[Property]>, undefined> | undefined; } & { [Property in Exclude<keyof T, { [Property in keyof T]: T[Property]["isOptional"] extends "optional" ? Property : never; }[keyof T]>]: Infer<T[Property]>; }>, T, "required", { [Property in keyof T]: Property | `${Property & string}.${T[Property]["fieldPaths"]}`; }[keyof T] & string>, {}, {}, {}>;
    doc: import("convex/values").VObject<import("convex/server").Expand<{ [Property in (Expand<T & {
        _id: import("convex/values").VId<GenericId<TableName>, "required">;
        _creationTime: import("convex/values").VFloat64<number, "required">;
    }> extends infer T_1 extends Record<string, import("convex/values").GenericValidator> ? { [Property in keyof T_1]: T_1[Property]["isOptional"] extends "optional" ? Property : never; } : never)[keyof Expand<T & {
        _id: import("convex/values").VId<GenericId<TableName>, "required">;
        _creationTime: import("convex/values").VFloat64<number, "required">;
    }>]]?: Exclude<Infer<Expand<T & {
        _id: import("convex/values").VId<GenericId<TableName>, "required">;
        _creationTime: import("convex/values").VFloat64<number, "required">;
    }>[Property]>, undefined> | undefined; } & { [Property_1 in Exclude<keyof Expand<T & {
        _id: import("convex/values").VId<GenericId<TableName>, "required">;
        _creationTime: import("convex/values").VFloat64<number, "required">;
    }>, (Expand<T & {
        _id: import("convex/values").VId<GenericId<TableName>, "required">;
        ...
        _id: import("convex/values").VId<GenericId<TableName>, "required">;
        _creationTime: import("convex/values").VFloat64<number, "required">;
    }> extends infer T_2 extends import("convex/values").PropertyValidators ? { [Property_2 in keyof T_2]: Property_2 | `${Property_2 & string}.${T_2[Property_2]["fieldPaths"]}`; } : never)[keyof Expand<T & {
        _id: import("convex/values").VId<GenericId<TableName>, "required">;
        _creationTime: import("convex/values").VFloat64<number, "required">;
    }>] & string>;
